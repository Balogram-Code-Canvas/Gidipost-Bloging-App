...
const AddBlog = () => {
  ...
  // ✅ Only initialize Quill once in useEffect
  useEffect(() => {
  ...
  return (
    <div className='flex-1 flex flex-col bg-gray-50 dark:bg-gray-900 overflow-hidden'>
      <form onSubmit={onSubmitHandler} className='flex-1 flex flex-col overflow-hidden'>
        <div className='flex-1 overflow-y-auto'>
          <div className='max-w-3xl mx-auto py-8 px-4 sm:px-8'>
            ...
            <button
              disabled={isAdding}
              type='submit'
              className='w-full sm:w-auto px-10 py-3 bg-primary text-white rounded-lg cursor-pointer text-sm font-medium hover:bg-primary/90 transition-all disabled:opacity-70 disabled:cursor-not-allowed mb-8'
            >
              {isAdding ? (
